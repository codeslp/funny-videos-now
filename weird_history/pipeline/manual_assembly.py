...
# Fix for PyTorch 2.6 weights_only=True security preventing Pyannote / WhisperX from loading
...
def run():
    ...
    timeline_path = "/Users/bfaris96/Claude Code Markdown/funny_video_generator/weird_history/pipeline/sleeping_with_moldy_cake_timeline.json"
    ...
    try:
        ...
        print(f"WhisperX Python API failed: {e}")
        word_timestamps = []
