...
def main():
    build_dir = "/Users/bfaris96/Claude Code Markdown/funny_video_generator/output/weird_history/spartan_spear"
    final_video_path = os.path.join(build_dir, "final_spear_video.mp4")
    tracking_topic = "Parting Hair with a Spartan Spear (Ancient Rome)"
    
    if not os.path.exists(final_video_path):
        print(f"Error: Could not find final video at {final_video_path}")
        return

    title = "✂️ The Ancient Roman Bridal Spear Ritual! | Weird History"
    description = (
        "If you thought modern weddings were stressful, imagine having your hair parted with an actual deadly weapon! 😱\n\n"
        "In Ancient Rome, a bride's hair was literally split down the middle using a \"hasta caelibaris\"—an iron spear that had officially been used to kill a gladiator or an enemy. They believed it blessed her with aggressive fertility!\n\n"
        "Could you sit still for a weapon in your hair? Let us know your thoughts in the comments below! 👇\n\n"
        "📖 Read the active historical research here: https://daily.jstor.org/why-roman-brides-parted-their-hair-with-a-spear/\n\n"
        "#weirdhistory #ancientrome #historyfacts #educationalcomedy #history"
    )
